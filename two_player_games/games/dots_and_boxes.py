...
#Klasa reprezentująca grę w kropki i pudełka
...
class DotsAndBoxesState(State):
    ...
    #Variables: str, „h” w przypadku linii poziomej lub „v” w przypadku linii pionowej
    #loc: współrzędne linii: (kolumna, wiersz) dla poziomego lub (wiersz, kolumna) dla pionowego
    ...
    def __init__(self,
        ...
        if horizontals and verticals and boxes:
            ...
            raise ValueError("Nie można zainicjować stanu, brakuje parametrów")
    ...
    # metody pomocnicze dla interfejsu publicznego
